...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-9axbk8q.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-9axbk8q.containers.anotherwebservice.com/
...
```
git clone git@github.com:rgdweb/container-9axbk8q.git
cd container-9axbk8q
```
...
```
docker attach container-9axbk8q
```
